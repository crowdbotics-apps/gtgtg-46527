"""
Django settings for gtgtg_46527 project.
...
WSGI_APPLICATION = 'gtgtg_46527.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gtgtg_46527 API",
    "DESCRIPTION": "API documentation for gtgtg_46527 App",
    "VERSION": "v1",
}
